...
class AdminNonCoffee extends StatefulWidget {
  const AdminNonCoffee({Key? key}) : super(key: key);

  @override
  State<AdminNonCoffee> createState() => _MenudataState();
}

class _MenudataState extends State<AdminNonCoffee> {
  Future<http.Response> getMenuByCategories() async {
    ...
    setState(() {
      ...
      listMenuByType = listMenu
          .where(((category) => category['type'] == 'Non Coffee'))
          .toList();
    });
    print('INI LISTMENU:');
    print(listMenu);
