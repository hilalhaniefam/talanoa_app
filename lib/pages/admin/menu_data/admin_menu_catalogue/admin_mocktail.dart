...
class AdminMocktail extends StatefulWidget {
  const AdminMocktail({Key? key}) : super(key: key);

  @override
  State<AdminMocktail> createState() => _MenudataState();
}

class _MenudataState extends State<AdminMocktail> {
  Future<http.Response> getMenuByCategories() async {
    ...
    setState(() {
      ...
      listMenuByType = listMenu
          .where(((category) => category['type'] == 'Mocktail'))
          .toList();
    });
    print('INI LISTMENU:');
    print(listMenu);
