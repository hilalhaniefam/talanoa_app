...
class AdminToastedBread extends StatefulWidget {
  const AdminToastedBread({Key? key}) : super(key: key);

  @override
  State<AdminToastedBread> createState() => _MenudataState();
}

class _MenudataState extends State<AdminToastedBread> {
  Future<http.Response> getMenuByCategories() async {
    ...
    setState(() {
      ...
      listMenuByType = listMenu
          .where(((category) => category['type'] == 'Toasted Bread'))
          .toList();
    });
    print(listMenu);
